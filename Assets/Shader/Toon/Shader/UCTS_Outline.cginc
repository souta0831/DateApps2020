...
//v2.0.4
				...
				//v.color.rが頂点カラーのR値。
				o.pos = UnityObjectToClipPos(lerp(float4(v.vertex.xyz + v.normal*Set_Outline_Width * v.color.r, 1), float4(v.vertex.xyz + _BakedNormalDir * Set_Outline_Width, 1), _Is_BakedNormal));
#elif _OUTLINE_POS
