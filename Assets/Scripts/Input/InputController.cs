...
public static class InputController
{
    ...
    public static void SetDefault()
    {
        ...
        controller.Axes[Axis.L_Horizontal].SetAxisName("Horizontal");
        controller.Axes[Axis.L_Vertical].SetAxisName("Vertical");
        controller.Axes[Axis.R_Horizontal].SetAxisName("Horizontal2");
        controller.Axes[Axis.R_Vertical].SetAxisName("Vertical2");
